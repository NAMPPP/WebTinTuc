...
<!-- Theme style -->
<link rel="stylesheet"
	href="<c:url value="/AdminLTE-3.2.0/dist/css/adminlte.min.css" />"> --%>
</head>
...
<body class="hold-transition login-page">
	...
	<!-- jQuery -->
<%-- 	<script
		src="<c:url value="/AdminLTE-3.2.0/plugins/jquery/jquery.min.js"/>"></script>
	<!-- Bootstrap 4 -->
	<script
		src="<c:url value="/AdminLTE-3.2.0/plugins/plugins/bootstrap/js/bootstrap.bundle.min.js"/>"></script>
	<!-- AdminLTE App -->
