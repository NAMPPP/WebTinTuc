	...
	<section class="section first-section">
		<div class="container-fluid">
			<div class="masonry-blog clearfix">
				<c:forEach var="listNewsHot" items="${listNewsHot}"
					varStatus="status">
					<c:choose>
									...
									<div class="shadoweffect">
										<div class="shadow-desc">
											<div class="blog-meta">
												...
												<h4>
													<a href="tech-single.html" title="">${listNewsHot.title }</a>
												</h4>
												<small><a href="#" title="">${listNewsHot.createddate }</a></small>
								...
								<div class="masonry-box post-media">
									...
									<div class="shadoweffect">
										<div class="shadow-desc">
											<div class="blog-meta">
												<span class="bg-orange"><a
													href="tech-category-01.html" title="">Gadgets</a></span>
												<h4>
													<a href="tech-single.html" title="">${listNewsHot.title }</a>
												</h4>
												<small><a href="tech-single.html" title="">${listNewsHot.createddate }</a></small> <small><a href="tech-author.html"
													title="">by ${listNewsHot.createdby }</a></small>
											</div>
											<!-- end meta -->
										</div>
										<!-- end shadow-desc -->
									...
									<div class="shadoweffect">
										<div class="shadow-desc">
											<div class="blog-meta">
												...
												<small><a href="tech-single.html" title="">${listNewsHot.createddate}</a></small> 
			...
			<div class="row">
				<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
									...
									<div class="blog-box row">
										...
										<div class="blog-meta big-meta col-md-8">
											...
											<small class="firstsmall"><a class="bg-orange"
												href="#" title="">Gadgets</a></small> <small><a
												href="#" title="">${dept.createdDate}</a></small> <small><a
												href="#" title="">${dept.createdBy}</a></small> <small>
											</small>
										</div>
										<!-- end meta -->
									</div>
					...
					<script type="text/javascript">
						var totalPages = ${mode.totalPages};	
