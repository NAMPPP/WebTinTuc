				...
				<div class="page-wrapper">
					<div class="blog-title-area text-center">
						...
						<div class="blog-meta big-meta">
							<small><a href="#" title="">${news.createdDate}</a></small> <small><a
								href="tech-author.html" title=""> ${news.createdBy}</a></small> <small><a
								href="#" title=""><i class="fa fa-eye"></i> 2344</a></small>
						</div>
						<!-- end meta -->
					...
					<div class="single-post-media">
						...
						<img src="<c:url value="${img.img1}"/>" alt="" class="img-fluid">
					</div>
					<!-- end media -->
					...
					<div class="blog-content">
						<div class="pp">
							<p>${news.content}</p>
							<img src="<c:url value="${img.img2}"/>" alt=""
								class="img-fluid img-fullwidth">
							<h3>
								<strong>${content.content2}</strong>
							</h3>
						</div>
						<!-- end pp -->
						...
						<div class="pp">
							...
							<p>
								<img src="<c:url value="${dept.thumbnail}"/>" class="float-left"
									width="380" alt="">
					...
					<div class="blog-title-area">
						<div class="tag-cloud-single">
							<span>Tags</span> <small><a href="#" title="">lifestyle</a></small>
							<small><a href="#" title="">colorful</a></small> <small><a
								href="#" title="">trending</a></small> <small><a href="#"
								title="">another tag</a></small>
						</div>
						<!-- end meta -->
							...
							<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
								...
								<div class="topsocial">
									<a href="#" data-toggle="tooltip" data-placement="bottom"
										...
										title="Youtube"><i class="fa fa-youtube"></i></a> <a href="#"
									...
									<div class="media last-child">
										...
										<div class="media-body">
											...
											<p>Kickstarter seitan retro. Drinking vinegar stumptown
												yr pop-up artisan sunt. Deep v cliche lomo biodiesel Neutra
