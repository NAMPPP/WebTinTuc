...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="#" class="brand-link"> <img
		src="<c:url value="/Admin/dist/img/AdminLTELogo.png"/>" alt="AdminLTE Logo"
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			...
			<div class="info">
				<a href="#" class="d-block">${AdminInfo.userName}</a>
			</div>
		</div>
		<!-- Sidebar Menu -->
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column"
				...
				<li class="nav-item"><a href="#" class="nav-link"> <i
						...
						<p>
							Manage <i class="fas fa-angle-left right"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="/ST5/adminPage/listNewsportal/"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>List Newsportal</p>
						</a></li>
						<li class="nav-item"><a href="/ST5/adminPage/listCategory/"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>List Category</p>
						</a></li>
						<li class="nav-item"><a href="/ST5/adminPage/addNew/"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>Add Newsportal</p>
						</a></li>

					</ul></li>
				<li class="nav-item"><a href="/ST5/adminPage/contactUs/" class="nav-link">
				...
				<li class="nav-item"><a href="/ST5/loginPage/" 
					class="nav-link"> <i class="nav-icon fas fa-columns"></i>
						<p>Log Out</p>
				</a></li>
